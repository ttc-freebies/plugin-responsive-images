...
class ImageServiceProvider extends ServiceProvider
{
    ...
    private function getProvider()
    {
        if ($this->app instanceof LumenApplication) {
            $provider = '\Ttc\Intervention\Image\ImageServiceProviderLumen';
        } elseif (version_compare(IlluminateApplication::VERSION, '5.0', '<')) {
            $provider = '\Ttc\Intervention\Image\ImageServiceProviderLaravel4';
        } else {
            $provider = '\Ttc\Intervention\Image\ImageServiceProviderLaravelRecent';
        }
